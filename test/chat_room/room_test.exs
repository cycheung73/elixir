defmodule ChatRoom.RoomTest do
  ...
  setup do
    {:ok, _general} = ChatRoom.Room.start_link("general")
    {:ok, _games} = ChatRoom.Room.start_link("games")
    user = "Chris"
  ...
  test "chatroom (join, get_history, send_message, leave)" do
    user1 = "Chris"
    user2 = "Gabe"
  ...
  test "chatroom errors (join, get_history, send_message, leave)" do
    user1 = "Chris"
    user2 = "Gabe"
    message = "Greetings, everyone."
